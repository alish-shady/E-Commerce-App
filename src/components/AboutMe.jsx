...
export default function AboutMe() {
  return (
    <div className="text-size-e flex flex-col gap-4">
      ...
      <p>
        My name is{" "}
        <span className="font-montserrat-semibold">Ali Shapoori</span>, and I am
      ...
      <div className="text-size-d font-montserrat-semibold flex items-center gap-2">
        <h2 className="font-montserrat-semibold">Get in touch:</h2>
        <a
